...
for i = 1:num_points_test
    [theta1_given, theta2_given, theta3_given, theta4_given] = deal(angle_tension_input_test(1, i),...
        angle_tension_input_test(2, i),...
        angle_tension_input_test(3, i), ...
        angle_tension_input_test(4, i));
    if isnan(P_ex_end_test_points(1, i))
        continue
    end

    F_ex_end_applied = 0.25 * F_ex_end_test_points(:, i);
    P_ex_end_applied = P_ex_end_test_points(:, i);
    ...
    angle_tension_input_test(5:10, i) = T_cable_sensed;
end
